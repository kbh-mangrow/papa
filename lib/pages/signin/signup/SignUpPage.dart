...
import 'package:papa/pages/signin/signup/SignUpCompletePage.dart';
import 'package:papa/pages/signin/signup/SignUpStep1Page.dart';
                  ...
                  onTap: () {
                    setState(() {
                      if (index == 2) {
                        ...
                        //Navigation.startPageFade(context, SignUpComplatePage());
                        //전체 다 삭제하기
                        /*
                        Navigator.pushAndRemoveUntil(
                          context,
                          MaterialPageRoute(builder: (_) => SignUpComplatePage()),
                              (route) => false,
                        );
                         */
                        Navigator.pushReplacement(
                          context,
                          PageRouteBuilder(
                            pageBuilder: (_, __, ___) => SignUpComplatePage(),
